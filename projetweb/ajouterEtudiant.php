...
<body>
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="dropdown01">
            ...
            <a class="dropdown-item" href="afficherEtudiants.php">Chercher Etudiant</a>
  ...
  <main role="main">
    ...
    <div class="container">
      ...
      <h5 id="succes"><?php echo $succes ?></h5>
      <form id="myform" method="GET" action="ajouterEtudiant.php" name="formule">
        <!--
        ...
        <!--Bouton Ajouter-->
        <button type="submit" class="btn btn-primary btn-block" name="submittt">Ajouter</button>
